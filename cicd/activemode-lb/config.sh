...
spawn_docker_host --dock-type loxilb --dock-name llb1 --with-bgp yes --bgp-config $(pwd)/llb1_gobgp_config --extra-args "--cluster 10.10.10.2 --self 0"
spawn_docker_host --dock-type loxilb --dock-name llb2 --with-bgp yes --bgp-config $(pwd)/llb2_gobgp_config --extra-args "--cluster 10.10.10.1 --self 1"
...
config_docker_host --host1 llb1 --host2 r1 --ptype vlan --id 11 --addr 11.11.11.10/24
...
config_docker_host --host1 llb2 --host2 r1 --ptype vlan --id 11 --addr 11.11.11.20/24
...
config_docker_host --host1 ep1 --host2 r2 --ptype vlan --id 10 --addr 10.10.10.4/24 --gw 10.10.10.254

create_docker_host_vlan --host1 ep2 --host2 r2 --id 10 --ptype untagged
config_docker_host --host1 ep2 --host2 r2 --ptype vlan --id 10 --addr 10.10.10.5/24 --gw 10.10.10.254

create_docker_host_vlan --host1 ep3 --host2 r2 --id 10 --ptype untagged
config_docker_host --host1 ep3 --host2 r2 --ptype vlan --id 10 --addr 10.10.10.6/24 --gw 10.10.10.254

##HA state change
config_lb_state llb1 MASTER
config_lb_state llb2 MASTER
...
sleep 5
##Create LB rule
create_lb_rule llb1 20.20.20.1 --tcp=2020:8080 --endpoints=10.10.10.6:1,10.10.10.4:1,10.10.10.5:1 --mode=onearm --bgp
create_lb_rule llb2 20.20.20.1 --tcp=2020:8080 --endpoints=10.10.10.6:1,10.10.10.4:1,10.10.10.5:1 --mode=onearm --bgp

## Quagga Hash setting
$dexec r1 sysctl -w net.ipv4.fib_multipath_hash_policy=1
